const App = () => {
    return (
        <>
        <div className="h-screen w-screen fleex justify center items-center bg-purple-600">
            <div clasName=" h-3/6 w-[30%] flex justify-center items-center bg-white rounded-md shadow-2xl">
